...
namespace MovieApi.Migrations
{
    ...
    [Migration("20240822035729_add_table_movie_genre")]
    partial class add_table_movie_genre
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApi.Model.DomainModel.MovieGenre", b =>
                {
                    b.Property<Guid>("MoviesId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieApi.Model.DomainModel.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieApi.Model.DomainModel.MovieGenre", b =>
                {
                    b.HasOne("MovieApi.Model.DomainModel.Genres", "Genres")
                        .WithMany()
                        .HasForeignKey("GenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieApi.Model.DomainModel.Movies", "Moives")
                        .WithMany()
                        .HasForeignKey("MoviesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
